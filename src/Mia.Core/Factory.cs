...
namespace Mia
{
    public abstract class Factory : Part
    {
        ...
        {
            return ReflectionCreate("Mia", "Mia", productClassName);
        }
        public static Factory ReflectionCreate(string assemblyName, string nameSpaceName, string productClassName)
        {
            ...
            try
            {
                ...
                Type classType = Type.GetType("Mia.FactoryT`1");
                Type[] typeParams = new Type[] { Type.GetType(factoryClassName) };
            ...
            catch (TypeLoadException)
            {
                ...
                /*Type classType = Type.GetType("Mia.FactoryT`1");
                Type[] typeParams = new Type[] { Type.GetType("Mia." + name) };
                Type constructedType = classType.MakeGenericType(typeParams);
                factory = Activator.CreateInstance(constructedType) as Factory;*/
            }
            return factory;
